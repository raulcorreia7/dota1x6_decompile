...
function modifier_item_soul_keeper_custom_passive:IsHidden()		return false end
...
function modifier_item_soul_keeper_custom_active_ally:GetModifierHealthRegenPercentage()
